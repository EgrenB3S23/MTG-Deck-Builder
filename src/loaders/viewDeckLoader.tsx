...
export const viewDeckLoader = async (): Promise<IDeck> => {
	const deckStringFromLS: string = localStorage.getItem("deckActive") || JSON.stringify(emptyDeck); // if localStorage deck is missing or malformed, load empty deck instead.
